...
@section('page_title', 'Profile Utilisateur - '.$user->name)
@section('content')
    <div class="row">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="basic-info">
                            <table class="table table-bordered">
                                <tbody>
                                <tr>
                                    <td class="font-weight-bold">Nom Complet</td>
                                    <td>{{ $user->name }}</td>
                                </tr>
                                <tr>
                                ...
                                @if($user->user_type == 'parent')
                                    <tr>
                                        <td class="font-weight-bold">Enfant</td>
                                        <td>
                                ...
                                @if($user->user_type == 'teacher')
                                    <tr>
                                        <td class="font-weight-bold">Mes Cours</td>
                                        <td>
