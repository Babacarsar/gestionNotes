    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-classes" class="nav-link active" data-toggle="tab">Gestion des classes</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info border-0 alert-dismissible">
                                ...
                                <span>Lorsqu'une classe est créée, une section sera automatiquement créée pour la classe, vous pouvez la modifier ou ajouter plus de sections à la classe à <a target="_blank" href="{{ route('sections.index') }}">Gerer les  Sections</a></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('classes.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="name" value="{{ old('name') }}" required type="text" class="form-control" placeholder="Nom de la Classe ex : 6eme">
                                    </div>
                                </div>
                                ...
                                <div class="text-right">
                                    <button id="ajax-btn" type="submit" class="btn btn-primary">Valider<i class="icon-paperplane ml-2"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>
