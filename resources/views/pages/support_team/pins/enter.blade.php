...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"><i class="icon-alarm mr-2"></i> Entree PIN</h5>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <div class="col-md-6 offset-md-3">
                    <form method="post" action="{{ route('pins.verify', Qs::hash($student->id)) }}">
                        ...
                        <div class="form-group">
                            <label for="pin_code" class="font-weight-bold col-form-label">Enter Evalution Pin pour <span class="text-success font-size-lg">{{ $student->name }}</span></label>
