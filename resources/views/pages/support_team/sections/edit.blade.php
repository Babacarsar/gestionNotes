...
@section('page_title', 'Modifier La section de '.$s->my_class->name)
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Modifier La section de {{ $s->my_class->name }}</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <div class="col-md-6">
                    <form class="ajax-update" method="post" action="{{ route('sections.update', $s->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="name" value="{{ $s->name }}" required type="text" class="form-control" placeholder="Nom de la classe">
                            </div>
                        </div>
