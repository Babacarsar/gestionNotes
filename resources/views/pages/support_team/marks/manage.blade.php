...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title font-weight-bold">Remplir le formulaire pour gérer les notes</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
    ...
    <div class="card">
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-md-4"><h6 class="card-title"><strong>Matières: </strong> {{ $m->subject->name }}</h6></div>
