...
@section('page_title', 'Modifier Matière - '.$s->name. ' ('.$s->my_class->name.')')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Modifier Matière - {{$s->my_class->name }}</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <div class="col-md-6">
                    <form class="ajax-update" method="post" action="{{ route('subjects.update', $s->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="name" value="{{ $s->name }}" required type="text" class="form-control" placeholder="Nom Matière">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="slug" value="{{ $s->slug }}" type="text" class="form-control" placeholder="Abbreviation">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="coefficient" value="{{ $s->coefficient }}" type="number" class="form-control" placeholder="Coefficient">
                            </div>
                        </div>
